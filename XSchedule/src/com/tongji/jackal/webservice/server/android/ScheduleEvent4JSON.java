...
public class ScheduleEvent4JSON {
	...
	public ScheduleEvent4JSON() {

	}

	public ScheduleEvent4JSON(long serverId, String title, String location,
	...
	public ScheduleEvent4JSON(long clientId, long serverId) {// deleted
	...
	public ScheduleEvent4JSON(long clientId, long serverId, boolean isDeleted) {
		this.clientId = clientId;
		this.serverId = serverId;
		this.title = null;
		this.location = null;
	...
	public ScheduleEvent4JSON(long localId, long serverId, String title,
	...
	public static ScheduleEvent4JSON createDeletedEvent(long clientId,
			long serverId) {
		return new ScheduleEvent4JSON(clientId, serverId);
	}
