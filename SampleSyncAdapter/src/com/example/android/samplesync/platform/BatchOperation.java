...
final public class BatchOperation {
    ...
    public List<Uri> excuteCalendar(){
    	List<Uri> resultUris = new ArrayList<Uri>();
        ...
        // Apply the mOperations to the content provider
        try {
            ContentProviderResult[] results = mResolver.applyBatch(CalendarContract.AUTHORITY,
                    mOperations);
    ...
    public List<Uri> excuteCalendar2(){
    	List<Uri> resultUris = new ArrayList<Uri>();
        ...
        ContentProviderOperation cpo = mOperations.get(0);
        Uri uri = cpo.getUri();
